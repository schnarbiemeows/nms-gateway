package com.schnarbiesnmeowers.nmsgateway.exceptions.handler;

import com.schnarbiesnmeowers.nmsgateway.exceptions.limitter.InsufficientPermissionsException;
import com.schnarbiesnmeowers.nmsgateway.exceptions.limitter.UrlNotFoundException;
...
public class AppUserExceptionHandling implements ErrorController {
    ...
    private static final String URL_NOT_VALID = "URL not a valid pathway";
...
//    }
   ...
   @ExceptionHandler(HttpRequestMethodNotSupportedException.class)
    ...
    handleInsufficientPermissionsException(InsufficientPermissionsException exception) {
        logAction(exception.getMessage());
        return createHttpResponse(FORBIDDEN, NOT_ENOUGH_PERMISSION);
    }

    @ExceptionHandler(UrlNotFoundException.class)
    public ResponseEntity<HttpResponse> handleUrlNotFoundException(UrlNotFoundException exception) {
        logAction(exception.getMessage());
        return createHttpResponse(BAD_REQUEST, URL_NOT_VALID);
    }
