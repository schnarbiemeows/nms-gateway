...
public class AppUserDTO implements Serializable {
	...
	public AppUser toEntity() {
		return new AppUser(this.userId,this.authorizations,this.email,this.firstName,this.actv,this.userNotLocked,
				this.joinDate,this.age,this.phone,this.lastLoginDate,this.lastLoginDateDisplay,this.lastName,
				this.password,this.profileImage,this.roles,this.userIdentifier,this.userName);
	}
}
